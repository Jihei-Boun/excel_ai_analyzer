...
from core.schema.column_match import find_mentioned_column
from core.constants import CODE_PAIR_SAMPLE_SIZE
from core.io.excel_loader import find_merged_header_pair, merged_header_base
from core.pai.pandasai_config import is_total_label, prepare_dataframe_for_ai
from core.profile_loader import column_hints_for
from core.filter.value_filter import format_context_label
...
def expects_list_display(prompt: str) -> bool:
    ...
    from core.schema.schema_compare import is_schema_request
